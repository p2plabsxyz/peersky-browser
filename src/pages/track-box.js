class TrackedBox extends HTMLElement {
    ...
    initWebView() {
      ...
      this.webview.addEventListener('did-navigate', (e) => {
        this.dispatchEvent(new CustomEvent('did-navigate', { detail: { url: this.webview.getURL() } }));
      });
      this.webview.addEventListener('page-title-updated', (e) => {
        this.dispatchEvent(new CustomEvent('page-title-updated', { detail: { title: e.title } }));
      });
    ...
    // Adding methods to control the webview directly
    goBack() {
