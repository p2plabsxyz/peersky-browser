...
<img src="./images/peersky-memory-saver.png" width="800" alt="Memory Saver benchmark – 10 tabs, Memory Saver OFF vs ON" />

> **Benchmark** — 10 tabs opened, measured via Windows Task Manager.
>
...
>
> Chart generated by [`dist/memory_benchmark.py`](../dist/memory_benchmark.py).
